<section class="bg-gray-50 p-6 rounded-lg shadow-lg">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm">
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 transition duration-300" :value="old('name', $user->name)" required autofocus autocomplete="name" />
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm">
            ...
            <x-text-input id="email" name="email" type="email" class="mt-1 block w-full border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 transition duration-300" :value="old('email', $user->email)" required autocomplete="username" />
